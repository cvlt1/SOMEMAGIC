...
<td><fmt:formatDate pattern="yyyy-MM-dd" value="${page.updated}" /></td>
<td class="right"><a class="btn-floating" href="${pagesPage}/${page.id}"><i class="material-icons">info</i></a> 
...
<a class="waves-effect waves-light btn right" href="${pagespagesPage}/add"><i class="material-icons">add</i></a>